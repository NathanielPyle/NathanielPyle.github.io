...
regfit.best=regsubsets(quality~.,data = white_wine[train1,],
                       nvmax=11)
test.mat =  model.matrix(quality~.,data = white_wine[test1,])
...
+ val.errors [i]= mean(( white_wine$quality[test]-pred)^2)
}
